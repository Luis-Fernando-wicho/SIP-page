    ...
    <div className="main-content">
      <section className="introduction">
        <div className="introduction__container ">
          <h1 className="introduction__title">CAMARAS DE SEGURIDAD</h1>
          <p className="introduction__description">
            Proteja lo que más importa con nuestras soluciones avanzadas en
            videovigilancia. No solo instalamos cámaras; diseñamos sistemas
            integrales de monitoreo que le brindan tranquilidad las 24 horas del
            día, sin importar dónde se encuentre.
          </p>
        </div>

        <video
          ref={videoRef} // Conectamos el video con la referencia
          className="introduction__video"
          autoPlay
          loop
          muted
          playsInline
          onMouseEnter={handleMouseEnter} // Evento cuando entra el mouse
          onMouseLeave={handleMouseLeave} // Evento cuando sale el mouse
        >
      ...
      <section className="portfolio">
        <video
          ref={videoRef2} // Conectamos el video con la referencia
        ...
        <div className="portfolio__galery">
          ...
          <div className="portfolio__galery_carrousel">
            <img
              ...
              alt=""
              className="portfolio__galery_image"
            />
            <img
